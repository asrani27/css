...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Chat</b>BOX</span>
    </a>
          ...
          <div class="box box-success direct-chat direct-chat-success">
            ...
            <div class="box-body">
              ...
              <div class="direct-chat-messages">
                ...
                @if($item->id_guest == $id_guest)
                <div class="direct-chat-msg right">
                  <div class="direct-chat-info clearfix">
                    <span class="direct-chat-name pull-right">{{$item->guest->nama_guest}}</span>
                    <span class="direct-chat-timestamp pull-left">{{$item->created_at->format('H:i')}}</span>
                  </div>
                  <!-- /.direct-chat-info -->
                  <img class="direct-chat-img" src="http://css-registration.banjarmasinkota.go.id/upload/foto/{{$item->guest->foto}}" alt="Message User Image"><!-- /.direct-chat-img -->
                ...
                <div class="direct-chat-msg">
                  <div class="direct-chat-info clearfix">
                    <span class="direct-chat-name pull-left">{{$item->guest->nama_guest}}</span>
                    <span class="direct-chat-timestamp pull-right">{{$item->created_at->format('H:i')}}</span>
                  </div>
                  <!-- /.direct-chat-info -->
                  <img class="direct-chat-img" src="http://css-registration.banjarmasinkota.go.id/upload/foto/{{$item->guest->foto}}" alt="Message User Image"><!-- /.direct-chat-img -->
                  <div class="direct-chat-text">
